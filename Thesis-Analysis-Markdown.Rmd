...
# Political affiliation (6 categories: Dem, Rep, Independent, Green party, Libertarian, No party, other. Ref: Dem)
...
# Convert Past contact to a factor and assign labels
...
head(d_accept$sr_12a_actions_contacted_officials)
str(d_accept$sr_12a_actions_contacted_officials_factor)

# Build ordinal logistic regression model
model_test <- d_accept %>% 
  polr(sr_12a_actions_contacted_officials_factor ~ race_white_dumvar + sr_9_worried, data = d_accept, Hess = TRUE)
