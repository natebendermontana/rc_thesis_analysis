...
### CIM - Costs
**It's not valid to do PCA on categorical variables. I either need to look at other methods to reduce complexity across these items in the CIM Costs group, or keep them as is.**
