...
```{r eval=T, echo=F}
# Checking missing values in all original vars that went into composite vars as output of factor analysis
...
# We drop from 1055 to 637 respondents when using listwise deletion
...
# (1055 - 777)/1055  # 26.3% of resp did not answer question
d_accept %>% 
